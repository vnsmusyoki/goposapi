CREATE TABLE IF NOT EXISTS sales_order_items (
    ...
    CONSTRAINT sales_order_items_numeric_non_negative
        CHECK (
            quantity > 0
            AND unit_cost >= 0
...
CREATE INDEX IF NOT EXISTS idx_sales_order_items_business_id
    ON sales_order_items (business_id);

CREATE INDEX IF NOT EXISTS idx_sales_order_items_deleted_at
